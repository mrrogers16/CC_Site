...
test.describe('Authentication Flow E2E Tests', () => {
  ...
  test.describe('User Login Flow', () => {
    test('should complete login process with valid credentials', async ({ page }) => {
  ...
  test.describe('Google OAuth Flow', () => {
    test('should show Google sign-in button on both pages', async ({ page }) => {
      // Check registration page
      await page.goto('/auth/register');
      await expect(page.locator('[data-testid="google-signin"]')).toBeVisible();
      await expect(page.locator('[data-testid="google-signin"]')).toContainText('Continue with Google');
  ...
  test.describe('Navigation and Layout', () => {
    test('should have consistent navigation on auth pages', async ({ page }) => {
      // Test registration page
      await page.goto('/auth/register');
      await expect(page.locator('[data-testid="site-navigation"]')).toBeVisible();
    ...
    test('should show benefits section on registration page', async ({ page }) => {
      await page.goto('/auth/register');
    ...
    test('should show support section on login page', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="support-section"]')).toBeVisible();
