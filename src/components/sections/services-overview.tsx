...
const services = [
  {
    ...
    description: "One-on-one sessions tailored to your personal growth and healing journey.",
    duration: "50 minutes",
  ...
  },
  {
    ...
    description: "Work together as a family to overcome challenges and build stronger bonds.",
    duration: "50 minutes",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {services.map((service) => (
            <div key={service.title} className="bg-card rounded-lg p-8 shadow-sm border border-border hover:shadow-md transition-shadow duration-200">
