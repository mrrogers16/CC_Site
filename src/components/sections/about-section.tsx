        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              ...
              specializes in helping individuals, couples, and families navigate
              through life&apos;s challenges with compassion and evidence-based
              therapeutic approaches.
            </p>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              She holds a Masters in Clinical Mental Health Counseling and is a
              Licensed Professional Counselor Associate (LPC-A) committed to
              creating a safe, non-judgmental space where healing and growth can
              flourish.
            </p>
