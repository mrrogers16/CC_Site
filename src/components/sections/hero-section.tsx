    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8 leading-relaxed">
          ...
          wellbeing. Compassionate, evidence-based therapy to help you navigate
          life&apos;s challenges.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              A safe, non-judgmental space where you can explore your feelings
              and experiences
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              Proven therapeutic approaches tailored to your unique needs and
              goals
            </p>
          </div>
