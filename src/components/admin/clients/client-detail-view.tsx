...
export function ClientDetailView({ client }: ClientDetailViewProps) {
  const [activeTab, setActiveTab] = useState<
    "overview" | "appointments" | "contact" | "activity"
  >("overview");
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            <div className="flex items-start justify-between mb-4">
              ...
              <span
                className={`inline-flex items-center px-3 py-1 text-sm font-medium rounded-full ${statusInfo.className}`}
              >
                {statusInfo.status}
              </span>
            </div>
                  ...
                  <dl className="space-y-2 text-sm">
                    ...
                    {client.reminderTime && (
                      <div className="flex justify-between">
                        ...
                        <dd className="text-foreground">
                          {client.reminderTime} hours before
                        </dd>
                      </div>
                    )}
                  </dl>
        ...
        <nav className="-mb-px flex space-x-8">
          {[
            { id: "overview", label: "Overview", count: null },
            {
              id: "appointments",
              label: "Appointments",
              count: client.recentAppointments.length,
            },
            {
              id: "contact",
              label: "Contact History",
              count: client.contactSubmissions.length,
            },
            {
              id: "activity",
              label: "Activity Timeline",
              count: client.activityTimeline.length,
            },
          ].map(tab => (
            <button
              key={tab.id}
