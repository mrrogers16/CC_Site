          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                We&apos;ve sent you a verification link to complete your account
                setup. Please check your email and click the link to verify your
                account.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Check your spam/junk folder. Sometimes verification emails can
                  end up there. Also verify you entered the correct email
                  address.
                </p>
