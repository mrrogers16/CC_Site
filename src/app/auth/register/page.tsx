...
export const metadata: Metadata = {
  ...
  description:
    "Create your account to access our counseling services and book appointments with ease.",
};
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                ...
                health. Create your account to access our services and schedule
                appointments.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center" data-testid="benefit-card">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M8 7V3a1 1 0 011-1h6a1 1 0 011 1v4M8 7h8M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V9a2 2 0 00-2-2h-2m-8 0V7"
                    />
                  </svg>
                </div>
                ...
                <p className="text-muted-foreground text-sm">
                  Schedule appointments quickly and manage your sessions with
                  our intuitive booking system.
                </p>
              </div>
              ...
              <div className="text-center" data-testid="benefit-card">
                ...
                <p className="text-muted-foreground text-sm">
                  Access your appointment history, manage your profile, and
