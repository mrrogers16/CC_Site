...
export const metadata: Metadata = {
  ...
  description: "Professional counseling services including individual therapy, couples counseling, and specialized mental health support tailored to your needs.",
};
